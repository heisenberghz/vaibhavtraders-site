...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "en_IN",
    url: siteUrl,
    title: `${siteConfig.name} | Interior Decorators & Execution Contractors in Udupi`,
    description:
      "Premier interior decorators, turnkey execution contractors, and plywood & hardware suppliers in Udupi. Over 23 years of trusted quality.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Vaibhav Traders - Premier Interior Decorators & Execution in Udupi",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Turnkey interior design execution, plywood supply, hardware, and aluminium fabrication in Udupi.",
  ...
  "@graph": [
    {
      ...
      knowsAbout: [
        "Plywood Supply",
        "Plywood Wholesale & Retail",
        "Marine Plywood Sourcing",
        "Interior Decoration",
  ...
  return (
    <html lang="en" className={`${inter.variable} ${poppins.variable} h-full`}>
      <body className="flex min-h-full flex-col bg-white antialiased">
        {/* Google Analytics */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-0DD6Z8M1PH"
